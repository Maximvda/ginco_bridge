...
typedef struct _Ginco__CanMessage Ginco__CanMessage;
...
struct  _Ginco__CanMessage
{
  ProtobufCMessage base;
  protobuf_c_boolean has_source_id;
  uint32_t source_id;
  protobuf_c_boolean has_event;
  protobuf_c_boolean event;
  protobuf_c_boolean has_linked;
  protobuf_c_boolean linked;
  protobuf_c_boolean has_ack;
  protobuf_c_boolean ack;
  protobuf_c_boolean has_feature_type;
  uint32_t feature_type;
  protobuf_c_boolean has_index;
  uint32_t index;
  protobuf_c_boolean has_function_address;
  uint32_t function_address;
  protobuf_c_boolean has_buffer_size;
  uint32_t buffer_size;
  protobuf_c_boolean has_data;
  uint64_t data;
};
#define GINCO__CAN_MESSAGE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ginco__can_message__descriptor) \
...
typedef enum {
  ...
  GINCO__COMMAND__COMMAND_CAN_MESSAGE = 2,
...
typedef void (*Ginco__Upgrade_Closure)
                 (const Ginco__Upgrade *message,
                  void *closure_data);
typedef void (*Ginco__CanMessage_Closure)
                 (const Ginco__CanMessage *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor ginco__can_message__descriptor;
